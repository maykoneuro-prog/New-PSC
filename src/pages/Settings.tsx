            ...
            <div className="bg-pedagogic-blue/5 p-6 rounded-xl border border-pedagogic-blue/20 mb-8">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-blue-700">Converte todas as unidades para CAIXA ALTA em todos os registros (Alunos, Agendamentos, Documentos). Isso resolve problemas de busca e filtragem.</p>
                </div>
                <button 
                  disabled={saving}
                  onClick={async () => {
                  ...
                  className="bg-pedagogic-blue text-white px-6 py-2 rounded-lg font-bold hover:bg-blue-700 transition-colors shadow-lg shadow-blue-100 disabled:opacity-50"
                >
